...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://github.com/0xh3x0x',
    email: 'kamleshkathiriya001@gmail.com',
    linkedin: 'https://www.linkedin.com/in/kamlesh-kathiriya',
